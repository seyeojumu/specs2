...
object build extends Build {
  ...
  lazy val specs2 = Project(
    ...
    fp, common, matcher, matcherExtra, core, scalaz, html, analysis,
    shapeless, form, markdown, gwt, junit, scalacheck, mock, tests).
    dependsOn(fp, common, matcher, matcherExtra, core, scalaz, html, analysis,
  ...
  lazy val specs2Settings: Seq[Settings] = Seq(
    ...
    scalazVersion in GlobalScope := "7.2.12",
    specs2ShellPrompt,
    scalaVersion := "2.12.2",
    crossScalaVersions := Seq(scalaVersion.value, "2.13.0-M1", "2.11.11", "2.10.6"))
